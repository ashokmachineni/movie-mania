...
const Header = ({ values }) => {
  ...
  const handleSubmit = e => {
    ...
    if (
      met === "" ||
      met === "Choose a search category" ||
      met === undefined ||
      ent === "" || ent === undefined
    ) {
      func2(null, [], "dont");
    } else {
      getDataFromTmdb(ent, met).then(e => {
    ...
    <React.Fragment>
      <section className="cover">
        ...
        <div className="content">
          ...
          <h3>
            Search And Explore Your Favorite Movies, Tv Shows, and Celebrities{" "}
          </h3>
          <form onSubmit={handleSubmit} className="search-form">
            <div className="form-group">
              <input
                ...
                placeholder="Enter Movie, Show Title / Celebrity Name"
                id="entry"
              />
            </div>
            <div className="form-group">
              ...
              >
                <option value="Choose a search category">
